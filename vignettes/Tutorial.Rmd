...
dependent and independent variables. The second input is dependent variable, which is a variable going to measure 
in our study and depends on the independent variables. The third input are independent variables, which are variables 
in a model used to forecast the outcome of dependent variable based on their values.
